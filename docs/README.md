...
**Duración total:** 60–70 min | Formato: 4 bloques (píldora extendida)
...
| `teoria_pydantic.pdf`                              | Todos        | Base teórica del Bloque 1 en PDF                                                            |
| `README.md`                                        | Todos        | Este documento                                                                              |

Además, la [web interactiva](https://masterclass-pydantic.vercel.app/) cubre la misma teoría del Bloque 1 en formato de slides navegables, con una demo en vivo de Pydantic ejecutándose en el navegador.
